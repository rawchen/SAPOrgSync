...
public class FormSearchDemo {


    public static String makeMd5TokenAndUrl(String queryId, String currentPage, String formID, String requestJson) {
    ...
    public static void main(String[] args) {
        System.out.println(makeMd5TokenAndUrl("3048", "0", null, "{\"ItemName\":\"SP%\"}"));
